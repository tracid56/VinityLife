local Components = {
	...
	{label = _U('tshirt_1'),					name = 'tshirt_1',			value = 15,		min = 0,	zoomOffset = 3.0,		camOffset = 0.15},
	{label = _U('tshirt_2'),					name = 'tshirt_2',			value = 0,		min = 0,	zoomOffset = 3.0,		camOffset = 0.15,	textureof	= 'tshirt_1'},
	{label = _U('torso_1'),					name = 'torso_1',			value = 134,		min = 0,	zoomOffset = 3.0,		camOffset = 0.15},
	{label = _U('torso_2'),					name = 'torso_2',			value = 2,		min = 0,	zoomOffset = 3.0,		camOffset = 0.15,	textureof	= 'torso_1'},
	...
	{label = _U('pants_1'),					name = 'pants_1',			value = 78,		min = 0,	zoomOffset = 3.0,		camOffset = -0.5},
	{label = _U('pants_2'),					name = 'pants_2',			value = 1,		min = 0,	zoomOffset = 3.0,		camOffset = -0.5,	textureof	= 'pants_1'},
	{label = _U('shoes_1'),					name = 'shoes_1',			value = 1,		min = 0,	zoomOffset = 0.8,		camOffset = -0.8},
	...
	{label = _U('chain_1'),					name = 'chain_1',			value = 2,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = _U('chain_2'),					name = 'chain_2',			value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65,	textureof	= 'chain_1'},
	{label = _U('helmet_1'),					name = 'helmet_1',			value = 65,		min = -1,	zoomOffset = 0.6,		camOffset = 0.65,	componentId	= 0 },
