...
function OpenSocietyActionsMenu()
  ...
  table.insert(elements, {label = 'Tequilala Ouvert',    value = 'tequi_ouvert'})
  table.insert(elements, {label = 'Tequilala Fermé',    value = 'tequi_ferme'})
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'tequi_ouvert' then
       TriggerServerEvent('AnnounceTequiOuvert')
      end 
      if data.current.value == 'tequi_ferme' then
       TriggerServerEvent('AnnounceTequiFerme')
      end
