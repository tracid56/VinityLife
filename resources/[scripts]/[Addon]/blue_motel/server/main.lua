    ...
    function(rowsChanged)
      ...
      for i=1, #xPlayers, 1 do
        ...
        if xPlayer.identifier == owner then
          ...
          if rented then
            --  TriggerClientEvent("pNotify:SendNotification",-1, {text = 'Vous <font color="aqua">avez</font> loué une chambre pour la somme de ' .. price .. '<font color="lime">$</font>/weekend', type = "error", timeout = 5000, layout = "bottomCenter"})
...
AddEventHandler('froberg_motell:rentMotell', function(motellName)
  ...
  SetMotellOwned(motellName, motell.price / 5000, true, xPlayer.identifier)
