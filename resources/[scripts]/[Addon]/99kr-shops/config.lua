Config = {
    ...
    Items = {
        ["drinks"] = {
            {label = "Coca Cola", item = "cocacola", price = 7},
            {label = "Fanta Exotic", item = "fanta", price = 5},
            {label = "Sprite", item = "sprite", price = 8},
            {label = "Loka Crush", item = "loka", price = 11},
        },
        ["snacks"] = {
        ...
        ["diverse"] = {
            ...
            {label = "Jumelles", item = "jumelles", price = 55},
            {label = "Appât à Poisson", item = "fishbait", price = 25},
            {label = "Canne à Pêche", item = "fishingrod", price = 250},
            {label = "Appât à Tortue", item = "turtlebait", price = 50},
