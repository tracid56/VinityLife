...
ESX.SavePlayers = function(cb)
	...
	for i=1, #xPlayers, 1 do
		table.insert(asyncTasks, function(cb)
			...
			TriggerClientEvent('esx:showNotification', -1, "☑️ Synchronisation effectuée")
		end)
	end

	Async.parallelLimit(asyncTasks, 8, function(results)
		RconPrint('Synchronisation effectué, toutes les données ont étés sauvegardés' .. "\n")
