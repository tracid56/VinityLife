Locales['fr'] = {
  ...
  -- Salary related
  ['received_salary'] = 'Votre patron a décidé de vous payer, quelle gentilesse !  ~g~+~g~$%s~s~',
  ['received_help'] = 'Votre actualisation a bien été prise en compte, ~g~$%s~s~ ~w~ont été virés sur votre compte.',
  ['company_nomoney'] = 'Votre patron est de mauvaise humeur :c. Vous recevez donc ~r~+0$ ~w~sur votre compte.',
  ['received_paycheck'] = 'Jour de paie',
  ['bank'] = 'Banque HSBC',
