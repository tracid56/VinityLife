...
AddEventHandler('debug:clearobjet', function()
	...
	for k,v in pairs(pickups) do
		...
		ESX.ShowAdvancedNotification("éboueur", "~g~Passage des éboueurs", "Les éboueurs son passé! ~g~"..platenum.." ~w~objet(s) ont été supprimé(s)", "CHAR_BUGSTARS", 8)
	end
	--print(pickups)
end)
